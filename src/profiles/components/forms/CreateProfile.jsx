...
import { createProfileAction } from '../../redux/action/profile.action';
const emptyForm = {
    company:"",
    website:"",
    location:"",
...
const CreateProfile = () => {
    ...
    //createprofile ==> true ==> we will divide the form
    //1. createprofile 2. editprofile
    ...
    const {company,website,location,status,skills,bio,githubusername,youtube,twitter,facebook,linkedin,instagram} = formState;
    const onChange = (e) => {
        setFormState({
            ...formState,
  ...
  return (
    ...
    <section class="container">
      ...
      <form class="form" onSubmit = {onSubmit}>
        ...
        <div class="form-group">
          <input type="text" placeholder="* Skills" name="skills" onChange={onChange} />
          <small class="form-text"
        ...
        <div class="form-group">
          <textarea placeholder="A short bio of yourself" name="bio" onChange={onChange}></textarea>
